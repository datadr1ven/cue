...
const { deliverHttp, applyAlertTag } = await import("cue/delivery.js");
...
const { createPipeline } = await import("cue/engine/pipeline.js");
const { readNdjsonEvents } = await import("cue/engine/ingest/ndjson.js");
const { resolve, dirname, join } = await import("path");
const { fileURLToPath } = await import("url");
const fixture = resolve(
  dirname(fileURLToPath(import.meta.url)),
  "../../../packages/cue/examples/f1/smoke-two-alerts.ndjson",
);
